...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("honos_entry_items_json", sa.String(), nullable=True),
        sa.Column("honos_discharge_items_json", sa.String(), nullable=True),
        sa.Column("honos_instrument", sa.String(), nullable=True),
        sa.Column("bscl_entry_items_json", sa.String(), nullable=True),
        sa.Column("bscl_discharge_items_json", sa.String(), nullable=True),
